...
const About: React.FC = () => {
  return (
    <Container data-scroll-wrapper id="sobre">
      <Grid
        container
        sx={{
          my: {
      ...
      >
        <Grid item xs={12} md={6}>
          ...
          >
            ...
            >
              <Image
                alt="Ilustração de uma troca de mensagens entre um grupo de 3 pessoas"
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            ...
            <Typography>
              ...
              tecnologia! Não temos fins lucrativos, nosso intuito é disseminar
              o conhecimento sobre tecnologia em Piracicaba, &quot;aonde o peixe
